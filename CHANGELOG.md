...
- **Критическое исправление рендеринга**: вертикальные полосы при отображении .npy и .tiff
  - NumPy: удалена некорректная конвертация Fortran-order (уже в column-major)
  - TIFF: добавлено транспонирование из row-major в column-major
